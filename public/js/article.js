...
function addarticle(e){
    ...
    var ispis=` <hr/>
                <div class="mb-4" class="article" id="article">
                    ...
                    <input type="text" id="name+br" name="name" class="form-control" placeholder="Name">
                    <label for="description" class="form-label">Name</label>
                    <input type="text" id="description+br" name="description" class="form-control" placeholder="description">
